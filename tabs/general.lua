...
local function classAuraBar(parent)
	...
	f.Update = function(self)
		if not ns.Mainline then return self:Hide() end
...
function general:Create(  )
	...
	local partyinarena = createCheckButton(self, "General_PartyInArena", 'showPartyInArena', true)
	partyinarena:SetPoint('TOPLEFT', showparty, 'BOTTOMLEFT', INDENT, -CB_GAP)
	local selfinparty = createCheckButton(self, "General_SelfInParty", 'showSelfInParty', true)
	selfinparty:SetPoint('TOPLEFT', partyinarena, 'BOTTOMLEFT', 0, -CB_GAP)
	local showArena = createCheckButton(self, "General_Arena", 'showArena', true)
	showArena:SetPoint('TOPLEFT', selfinparty, 'BOTTOMLEFT', -INDENT, -CB_GAP)
	...
	enablecb:SetPoint('TOPLEFT', showBoss, 'BOTTOMLEFT', 0, -(CB_GAP))
	...
	portraitT:SetPoint('TOPLEFT', showTicks, 'BOTTOMLEFT', -INDENT, (-CB_GAP))
